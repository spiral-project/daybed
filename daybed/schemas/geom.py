...
class PointNode(SchemaNode):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(PointNode, self).__init__(Sequence(), SchemaNode(
            Float()), **defaults)
...
class GeometryField(TypeField):
    ...
    Positions are coordinates following *x, y, z* order (or
    *longitude, latitude, altitude*) for geographic coordinates). A
    minimum of two dimensions is required, but any number of
