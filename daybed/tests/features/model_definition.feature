Feature: Model definitions
    ...
    Scenario: Wrong methods and dummy data
        When I access with empty model name
        When I want to define a Mushroom
        When I access with a wrong method
        When I send "", the status is 400
        When I send "{'X'-: 4}", the status is 400

    Scenario: Malformed model definition
        When I want to define a Mushroom
        And I send "{"title": "Mushroom"}", the status is 400
        And The error is about "description" field
        And The error is about "fields" field
        
        When I want to define a Mushroom
        And I send "{"title": "Mushroom", "description": "Mushroom picking areas"}", the status is 400
        And The error is about "fields" field
    ...
    Scenario: Malformed model fields definition
        ...
        And The error is about "fields" field
        When I want to define a Mushroom
        And I define the fields "[{"name": "untyped"}]", the status is 400
        And The error is about "fields" field
